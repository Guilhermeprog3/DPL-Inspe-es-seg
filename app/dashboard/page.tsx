...
const actions = [
  ...
  },
  {
    ...
    description: 'Gerencie os pontos físicos de instalação, vincule equipamentos e acesse QR Codes.',
    cta: 'Ver locais',
    href: '/locais/lista',
  },
]
...
export default function DashboardPage() {
  ...
  overflow: hidden; 
        ...
        .db-logo-wrap { display: flex; flex-direction: column; align-items: center; margin-bottom: 32px; animation: dbFadeUp 0.5s ease forwards; }
        .db-logo-badge { display: inline-flex; align-items: center; gap: 8px; background: #fff; border: 1px solid rgba(9,71,128,0.1); border-radius: 100px; padding: 6px 16px 6px 8px; box-shadow: 0 2px 12px rgba(9,71,128,0.07); margin-bottom: 20px; }
        .db-logo-icon { width: 32px; height: 32px; border-radius: 8px; background: linear-gradient(135deg, #094780, #1a6ab5); display: flex; align-items: center; justify-content: center; }
        .db-logo-badge span { font-family: 'Syne', sans-serif; font-size: 13px; font-weight: 800; color: #094780; letter-spacing: 2px; }
        .db-version { font-size: 10px; font-weight: 700; background: rgba(230,122,14,0.12); color: #E67A0E; padding: 2px 7px; border-radius: 100px; }
        .db-headline { font-family: 'Syne', sans-serif; font-size: 22px; font-weight: 800; color: #0d1e33; text-align: center; letter-spacing: -0.3px; }
        .db-subline { font-size: 13px; color: #8896ab; margin-top: 6px; text-align: center; }

        .search-container { width: 100%; max-width: 500px; margin: 0 auto 40px; position: relative; animation: dbFadeUp 0.5s ease forwards; animation-delay: 0.08s; opacity: 0; }
        .search-input { width: 100%; padding: 13px 20px 13px 48px; background: #fff; border: 1px solid rgba(9,71,128,0.1); border-radius: 12px; font-family: 'DM Sans', sans-serif; font-size: 14px; color: #0d1e33; box-shadow: 0 4px 20px rgba(9,71,128,0.04); transition: all 0.2s ease; }
  ...
  box-sizing: border-box; 
        ...
        .db-card-bar { position: absolute; top: 0; left: 0; right: 0; height: 3px; transform: scaleX(0); transform-origin: left; transition: transform 0.3s ease; border-radius: 18px 18px 0 0; }
        .db-card:hover .db-card-bar { transform: scaleX(1); }

        .db-card-bg { position: absolute; top: -40px; right: -40px; width: 130px; height: 130px; border-radius: 50%; opacity: 0.5; pointer-events: none; transition: transform 0.3s ease; }
        .db-card:hover .db-card-bg { transform: scale(1.15); }

        .db-card-icon { width: 48px; height: 48px; border-radius: 13px; display: flex; align-items: center; justify-content: center; margin-bottom: 18px; position: relative; box-shadow: 0 4px 14px rgba(0,0,0,0.12); }

        .db-card-title { font-family: 'Syne', sans-serif; font-size: 15px; font-weight: 700; color: #0d1e33; line-height: 1.25; margin-bottom: 8px; }
        .db-card-desc { font-size: 12px; color: #8896ab; line-height: 1.6; flex: 1; margin-bottom: 22px; }
        .db-card-cta { display: flex; align-items: center; gap: 7px; font-size: 12px; font-weight: 600; background: none; border: none; cursor: pointer; padding: 0; font-family: 'DM Sans', sans-serif; transition: gap 0.18s ease; }
            ...
            filteredActions.map((a, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="db-card-icon" style={{ background: `linear-gradient(135deg, ${a.color} 0%, ${a.color}cc 100%)` }}>
