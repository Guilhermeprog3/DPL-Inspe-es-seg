...
const actions = [
  {
    ...
    description: 'Acompanhe e gerencie a taxa de contato dos colaboradores por período, regional e supervisor.',
    cta: 'Acessar módulo',
    href: '/gestao-funcionarios/taxa-contato',
  },
  {
    icon: CheckSquare,
    color: '#10b981',
...
export default function GestaoFuncionariosDashboardPage() {
  ...
  return (
    <DashboardLayout
      title="Dashboard"
      breadcrumb="SIGS / Gestão de Funcionários"
      navItems={navItems}
    >
