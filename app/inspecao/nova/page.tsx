...
import { mockEquipamentos, mockChecklistTemplates } from '@/lib/mock-data' // Removido mockInspecoes
...
export default function InspecaoPage() {
  ...
  return (
    <DashboardLayout title="Nova Inspeção" breadcrumb="SIGS / Inspeção / Nova">
      {/* Ajustado para max-width centralizado em vez de grid de 2 colunas */}
      <div className="max-width-[800px] mx-auto space-y-4">
