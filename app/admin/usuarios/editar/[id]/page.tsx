...
export default function EditarUsuarioPage() {
  ...
  return (
    <DashboardLayout title="Editar Usuário" navItems={navItems} accentColor="#094780">
      <div className="-mx-4 md:-mx-7 -mt-4 md:-mt-7 mb-6 bg-white border-b border-[#e3e8ef] px-4 md:px-7 py-3 flex justify-between items-center">
        <button onClick={() => router.push('/admin/usuarios')} className="text-[13px] text-[#9ca3af] flex items-center gap-1.5">
          <ArrowLeft size={13} /> Usuários › <span className="text-[#094780] font-semibold">Editar Usuário</span>
        </button>
        <span className="text-[11px] font-mono text-[#9ca3af] bg-[#f4f6f9] px-2.5 py-1 rounded-md">
